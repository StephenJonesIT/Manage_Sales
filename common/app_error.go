...
func ErrIntenal(err error) *AppError{
...
func ErrEntityExitested(entity string, err error) *AppError{
	return NewCustomError(
		err,
		fmt.Sprintf("%s already exitsts", strings.ToLower(entity)),
		fmt.Sprintf("Err%sAlreadyExitsts", entity),
	)
}
...
func ErrCannotCreateEntity(entity string, err error) *AppError{
	return NewCustomError(
		...
		fmt.Sprintf("ErrCannotCreateEntity%s", entity),
	)
}

func ErrCannotPermission(entity string, err error) *AppError{
	return NewCustomError(
		err,
